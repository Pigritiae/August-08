document.addEventListener('DOMContentLoaded', () => {
    ...
    function drawChart() {
        ...
        if (priceHistory.length < 2) {
            ...
            ctx.fillText('No data to Show in the Graph.',
        ...
        for (let i =0; i <= yAxisSteps; i++) {
            ...
            const priceValue = effectiveMinPrice +
            (i / yAxisSteps) * effectivePriceRange;
        ...
        priceHistory.forEach((price, index) => {
            ...
            const y = padding + chartHeight -
            ((price - effectiveMinPrice) / effectivePriceRange) *
            chartHeight;
        ...
        ((priceHistory[priceHistory.length - 1] - effectiveMinPrice)
        / effectivePriceRange) * chartHeight;
        ctx.beginPath();
    ...
    function updateStockData() {
        ...
        priceChangeSpan.classList.remove
